...
def main():
    ...
    parser.add_argument(
        "input_file", nargs="+", type=str, help="paths to video files to transcribe"
    )
    parser.add_argument(
        "--model",
        default="small",
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="lanuage in the video; default to be None, so it will be detected by Whisper",
    )
    ...
    audios = get_audio(args.pop("input_file"))
...
def get_audio(paths) -> dict[str, str]:
